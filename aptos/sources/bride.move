module bridge::aptos_nft_bridge {
  ...
  public entry fun lock_721(
    ...
    if(nft_already_exists) {
      ...
      table::add(&mut bridge_data.nft_collection_tokens, CollectionNftObject { collection: collection_address, nft_address: token_address}, *nft_token_id);
    };
  ...
  public entry fun claim_721(
    ...
    source_chain: vector<u8>,
    source_nft_contract_address: vector<u8>,
    token_id: String, // we will use this to generate token name e.g. Collection # 1
    transaction_hash: vector<u8>,
    nft_type: vector<u8>,
