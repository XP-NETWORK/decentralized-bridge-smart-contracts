...
export async function deployStorageFactory(owner: string | undefined) {
  ...
  try {
    ...
    console.log(
      `Waiting for Storage Factory Contract ${originated.contractAddress} to be confirmed...`
    );
    await originated.confirmation(2);
    console.log("Storage Factory Contract: ", originated.contractAddress);
...
if (require.main === module) {
  (async () => {
    ...
    await deployStorageFactory(owner);
  })();
}
