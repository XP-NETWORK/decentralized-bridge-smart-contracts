...
interface INFTStorageDeployer {
    ...
    /**
     * @dev Deploy a new NFTStorageERC1155 contract with the specified collection address.
     *
     * @param collectionAddress The address of the ERC1155 collection.
     * @return The address of the newly deployed NFTStorageERC1155 contract.
     */
