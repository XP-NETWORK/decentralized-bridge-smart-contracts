...
contract ERC721Royalty is   ERC721URIStorage, IERC2981 {
    mapping(uint256 => address) private _royalityRecievers;
    mapping(uint256 => uint256) private _royalties;
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {}
    function mint(address to, uint256 tokenId, uint256 royalty, address royalityReciever, string memory tokenURI) external {
